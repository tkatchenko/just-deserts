...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utility_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utility.js */ \"../js/utility.js\");\n/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./map.js */ \"../js/map.js\");\n/* harmony import */ var _output_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./output.js */ \"../js/output.js\");\n/* harmony import */ var _attributes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./attributes.js */ \"../js/attributes.js\");\n/* harmony import */ var _player_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./player.js */ \"../js/player.js\");\n/* harmony import */ var _wall_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wall.js */ \"../js/wall.js\");\n/* harmony import */ var _tile_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tile.js */ \"../js/tile.js\");\n/* harmony import */ var _enemy_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./enemy.js */ \"../js/enemy.js\");\n\n\n\n\n\n\n\n\n\nconst debug = true;\n\nconst output = new _output_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](document.querySelector('#output .box'), debug);\nconst map = new _map_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](document.querySelector('#map .box'), 50, 50, output);\nconst attributes = new _attributes_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](document.querySelector('#attributes .box'));\n\nconst tiles = [];\nfor (let i = 0; i < 50; i++) {\n  tiles.push(new _tile_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"](\n    'Road',\n    '≡',\n    i,\n    28,\n    '#d60',\n    map\n  ));\n}\n\nconst walls = [];\nfor (let i = 0; i < 500; i++) {\n  const x = Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(0, 50);\n  const y = Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(0, 50);\n\n  if (!map.checkAllCollision({x: x, y: y})) {\n    walls.push(new _wall_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"](\n      'Cactus',\n      '🌵',\n      x,\n      y,\n      10,\n      map,\n      output\n    ));\n  }\n}\n\nconst enemies = [];\nfor (let i = 0; i < 20; i++) {\n  const x = Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(0, 50);\n  const y = Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(0, 50);\n  \n  if (!map.checkCollision({x: x, y: y})) {\n    enemies.push(new _enemy_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"](\n      'Lizard',\n      '🦎',\n      x, \n      y,\n      10,\n      10,\n      0,\n      0,\n      0.5,\n      map,\n      output\n    ));\n  }\n}\n\nenemies.push(new _enemy_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"](\n  'Lizard',\n  '🦎',\n  Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(20, 24), \n  28,\n  0,\n  10,\n  10,\n  0,\n  0,\n  map,\n  output\n));\n\nenemies.push(new _enemy_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"](\n  'Bus',\n  '🚌',\n  25,\n  28,\n  1000000,\n  1000000,\n  1000000,\n  1000000,\n  2,\n  map,\n  output,\n  function() {\n    while (this.timePool >= 1) {\n      if (this.x - 2 < 0) {\n        this.map.clear(this.x, this.y);\n        this.remove = true;\n      } else {\n        this.move(-1, 0);\n      }\n\n      this.timePool--;\n    }\n  },\n  true\n));\n\nconst playerHealthAddition = Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(0, 50);\nconst playerAttributeDiff = Object(_utility_js__WEBPACK_IMPORTED_MODULE_0__[\"getRandomInt\"])(0, 10);\nconst playerAttributeAddition = 10 - Math.floor(playerHealthAddition / 10);\n\nconst player = new _player_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\n  'Player',\n  '🧔🏽',\n  25,\n  25,\n  100 + playerHealthAddition,\n  100 + playerHealthAddition,\n  5 + playerAttributeDiff + playerAttributeAddition,\n  5 + 10 - playerAttributeDiff + playerAttributeAddition,\n  1,\n  map,\n  output,\n  attributes\n);\n\nwalls.push(new _wall_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"](\n  'Cactus',\n  '🌵',\n  25,\n  26,\n  20,\n  map,\n  output\n));\n\ndocument.addEventListener('keydown', (event) => {\n  const keyName = event.key;\n\n  switch (keyName) {\n    case 'ArrowUp':\n    case 'k':\n      player.move(0, -1);\n      break;\n    case 'ArrowRight':\n    case 'l':\n      player.move(1, 0);\n      break;\n    case 'ArrowDown':\n    case 'j':\n      player.move(0, 1);\n      break;\n    case 'ArrowLeft':\n    case 'h':\n      player.move(-1, 0);\n      break;\n    case 'y':\n      player.move(-1, -1);\n      break;\n    case 'u':\n      player.move(1, -1);\n      break;\n    case 'b':\n      player.move(-1, 1);\n      break;\n    case 'n':\n      player.move(1, 1);\n      break;\n  }\n\n  enemies.forEach((enemy, i, array) => {\n    if (!enemy.remove) {\n      enemy.timePool += enemy.speed / player.speed;\n\n      enemy.update();\n    }\n  });\n\n  enemies.forEach((enemy, i, array) => {\n    if (enemy.remove) {\n      array.splice(i, 1); \n    }\n  });\n}, false);\n\noutput.log('The bus leaves while you are taking a rest break.');\n\n\n//# sourceURL=webpack:///../js/index.js?");
